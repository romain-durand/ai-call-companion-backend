...
BEGIN
  ...
  -- Insert collection phone number only if it doesn't already exist for this account
  -- Note: +33939244855 is a shared collection number; we skip the insert if it already exists globally
  -- to avoid violating the unique constraint on e164_number.
  BEGIN
  ...
  EXCEPTION WHEN unique_violation THEN
    -- Number already exists for another account; skip silently
    NULL;
  END;
